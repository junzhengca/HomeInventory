...
const DetailLabel = styled(Text)`
  font-size: ${({ theme }: StyledProps) => theme.typography.fontSize.sm}px;
  font-weight: ${({ theme }: StyledProps) => theme.typography.fontWeight.semibold};
  color: ${({ theme }: StyledProps) => theme.colors.textSecondary};
  margin-bottom: ${({ theme }: StyledProps) => theme.spacing.xs}px;
`;
    ...
    >
      <ContentContainer>
        ...
        >
          ...
          {(errorDetails.status || errorDetails.responseBody) && (
            <Section>
              ...
              <DetailContainer>
                ...
                {errorDetails.responseBody && (
                  <DetailRowLast>
                    ...
                    <DetailText>{JSON.stringify(errorDetails.responseBody, null, 2)}</DetailText>
                  </DetailRowLast>
                )}
              </DetailContainer>
            </Section>
